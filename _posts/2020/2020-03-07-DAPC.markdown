...
<a href="https://hzz0024.github.io/example_data/WAL605_SNP68.gen" download>or here</a>
...
4. change the last sample ID in each population to its population name, which is useful for the DAPC figure legend plotting (see below)
