...
Example genepop dataset can be downloaded [here](https://hzz0024.github.io/example_data/WAL605_SNP68_genepop.txt)

### usage

### Data preparation
1. convert the vcf or plink format files to GENEPOP format using PGDspider
2. make necessary changes for DAPC data loading (e.g. one need to condense the SNP list in one row, assign individuals to populations using pop flag, see example gene pop file)
