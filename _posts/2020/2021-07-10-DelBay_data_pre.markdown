comments: true
title: DelBay 2019 & 20 data summary
...
1) Calculate the individual downsampling scale (p) for different relative coverages ratios (1x relative to 2019 average coverage, 0.91). Besides, the different coverage settings should be useful for batch effect evaluation (done before).            
2) Determine -setMaxDepth for each datasets - done.
3) Call SNP for each 2020 challenge dataset with 1x relative coverage.            
4) Produce a global SNP list by checking the shared SNPs between 2020 and 2019 datasets.   
...
File Del19_final_maf0.05_minmapq30_minq20_pctind0.7_CV30_masked_noinvers.snplist.txt SNPs: 2316848
File Del20_final_maf0.05_minmapq30_minq20_pctind0.7_CV30_masked_noinvers.snplist.txt SNPs: 2370545
Shared SNPs: 1744719
Private SNPs in Del19_final_maf0.05_minmapq30_minq20_pctind0.7_CV30_masked_noinvers.snplist.txt: 572129
Private SNPs in Del20_final_maf0.05_minmapq30_minq20_pctind0.7_CV30_masked_noinvers.snplist.txt: 625826
```

Table 2. Summary of total SNPs analyzed, sites retained after filtering, private sites, and shared sites during downsampling processing. Note Relative Coverage is determined as the coverage of Del20 samples relative to the Del19 (97 challenge samples) coverage: 0.78 (set as 1)

|                             |  Total SNPs   | SNPs after filtering    |  Private | Ratio  | Shared  | Ratio  |
|-----------------------------|---------------|-------------------------|----------|--------|---------|--------|
| Del19 (only challenge, n=97)| 509397167     | 2316848                 | 572129   | 24.69% | 1744719 | 75.31% |
| Del20 (challenge, n=101)    | 477735875     | 2370545                 | 625826   | 26.40% | 1744719 | 73.60% |
| Total (n=432)               | 512825791     | 1736050                 |          |        |         |        |


5) Perform PCA on global SNP datasets. 
