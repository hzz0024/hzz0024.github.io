...
```sh
Rscript --vanilla --slave fit_LDdecay.R --ld_files LD.list --out ref_ch.jpg --fit_level 0
```
Result withno fitting model
...
|---------------------|---------------|--------|-----------|   
|  ch_ngsLD_output r2 | 0.006095614   |0.4581553 |0.3406605 |     
| ref_ngsLD_output r2 | 0.003160602 |0.4473140 |0.3243038 |   
