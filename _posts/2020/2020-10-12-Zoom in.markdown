...
- Plotting the dxy for each group comparsion. Green zone is the outlier window with 10K SNPs (regardless of FDR as dxy only focus on the two population constrast). Red dots are two single-SNP oultiers 5_16551904 and 5_16552716.
