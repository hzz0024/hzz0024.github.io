...
Because we are mainly focus on the wild vs selected lines, I grouped the wild populations together for each location, and did the same for selected lines. Now we have four major locations and eight populations. For example, MEW1 and MEW2 are grouped together as Maine Wild (MEW), UMFS and MEH2 are grouped together as Maine Selected (MES). The populations used for domestication study are shown in the table column "ID for domestication study",
