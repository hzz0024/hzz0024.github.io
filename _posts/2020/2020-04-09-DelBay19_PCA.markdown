...
1. Populations would group together after excluding the inversions in the chromosome 5 ane 6   
2. It is hard to tell where the individual outliers come from. Need further angsd after removing the outliers above.
