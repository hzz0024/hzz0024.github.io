...
So far I used doMajorMinor to infer the minor allele and use doMaf -1 for allele frequency estimates. It seems that -doMaf 4 allows us to propagate the minor allele uncertainty into our allele freq estimate using beagle file, and this requires further investigation. 
