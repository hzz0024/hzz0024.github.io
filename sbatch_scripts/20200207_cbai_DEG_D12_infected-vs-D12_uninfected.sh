#!/bin/bash
## Job Name
#SBATCH --job-name=DEG_cbai_D12_inf-vs-D12_uninf
...
#SBATCH --chdir=/gscratch/scrubbed/samwhite/outputs/20200207_cbai_DEG/D12_infected-vs-D12_uninfected
