#!/bin/bash
## Job Name
#SBATCH --job-name=DEG_cbai_D26_infected-vs-D26_uninfected
...
#SBATCH --chdir=/gscratch/scrubbed/samwhite/outputs/20200207_cbai_DEG/D26_infected-vs-D26_uninfected
