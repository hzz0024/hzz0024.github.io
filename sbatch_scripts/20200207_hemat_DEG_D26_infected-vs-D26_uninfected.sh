#!/bin/bash
## Job Name
#SBATCH --job-name=DEG_hemat_D26_infected-vs-D26_uninfected
...
#SBATCH --chdir=/gscratch/scrubbed/samwhite/outputs/20200207_hemat_DEG/D26_infected-vs-D26_uninfected
